  ...
  <v-container fluid class="pa-0" v-if="state">
    <v-row>
      <v-col cols="12" md="6" lg="4" color="green"
        style="overflow: hidden; width: 650px!important;x"
        :style="{ height: '1100px' }"
      >
        <div
          style="height: 1100px!important; overflow-x: hidden; overflow-y: scroll; width: 850px"
        >
          <v-timeline
            side="end"
            align="end"
        ...
        >
            ...
            >
              ...
              <v-card-text class="pa-0">
                ...
                <div class="mr-4 d-inline-block text-body-2"
                  v-for="path in entry.path" :key="path"
                > <span>{{ path.text }}</span>
                </div>
                ...
                <v-card flat>
                  <v-card-text class="pa-0">
                    ...
                    <div class="mt-2" v-if="entry.content" style="padding-right: 50px">
                      ...
                      diam nonumy eirmod tempor invidunt <v-chip size="x-small" color="primary" @click=""># 14</v-chip> ut labore et dolore magna
